const COUNTRY_CODE = {
  ...
  '文莱': ['BN', 'AS', 'Asia/Brunei', 'UTC+8', '673'],
  ...
  '不丹': ['BT', 'AS', 'Asia/Thimphu', 'UTC+6', '975'],
  ...
  '库克群岛': ['CK', 'AS', 'Pacific/Rarotonga', 'UTC-10', '682'],
  '智利': ['CL', 'LA', 'America/Santiago', 'UTC-3', '56'],
  '喀麦隆': ['CM', 'AF', 'Africa/Douala', 'UTC+1', '237'],
  '中国': ['CN', 'AS', 'Asia/Shanghai', 'UTC+8', '86'],
  ...
  '圣诞岛': ['CX', 'AS', 'Indian/Christmas', 'UTC+7', '61'],
  '塞浦路斯': ['CY', 'AS', 'Asia/Nicosia', 'UTC+2', '357'],
  ...
  '斐济': ['FJ', 'AS', 'Pacific/Fiji', 'UTC+12', '679'],
  '福克兰群岛': ['FK', 'LA', 'Atlantic/Stanley', 'UTC-3', '500'],
  '密克罗尼西亚联邦': ['FM', 'AS', 'Pacific/Pohnpei', 'UTC+11', '691'],
  ...
  '格鲁吉亚': ['GE', 'AS', 'Asia/Tbilisi', 'UTC+4', '995'],
  ...
  '关岛': ['GU', 'AS', 'Pacific/Guam', 'UTC+10', '1671'],
  '几内亚比绍': ['GW', 'AF', 'Africa/Bissau', 'UTC-0', '245'],
  '圭亚那': ['GY', 'LA', 'America/Guyana', 'UTC-4', '592'],
  '中国-香港': ['HK', 'AS', 'Asia/Hong_Kong', 'UTC+8', '852'],
  ...
  '印度尼西亚': ['ID', 'AS', 'Asia/Jakarta', 'UTC+7', '62'],
  '爱尔兰': ['IE', 'EU', 'Europe/Dublin', 'UTC-0', '353'],
  '以色列': ['IL', 'AS', 'Asia/Jerusalem', 'UTC+2', '972'],
  '马恩岛': ['IM', 'EU', 'Europe/London', 'UTC-0', '441624'],
  '印度': ['IN', 'AS', 'Asia/Kolkata', 'UTC+5:30', '91'],
  '英属印度洋领地': ['IO', 'EU', 'Indian/Chagos', 'UTC+6', '246'],
  '伊拉克': ['IQ', 'AS', 'Asia/Baghdad', 'UTC+3', '964'],
  '伊朗': ['IR', 'AS', 'Asia/Tehran', 'UTC+3:30', '98'],
  ...
  '约旦': ['JO', 'AS', 'Asia/Amman', 'UTC+2', '962'],
  '日本': ['JP', 'AS', 'Asia/Tokyo', 'UTC+9', '81'],
  '肯尼亚': ['KE', 'AF', 'Africa/Nairobi', 'UTC+3', '254'],
  '吉尔吉斯斯坦': ['KG', 'AS', 'Asia/Bishkek', 'UTC+6', '331'],
  '柬埔寨': ['KH', 'AS', 'Asia/Phnom_Penh', 'UTC+7', '855'],
  '基里巴斯': ['KI', 'AS', 'Pacific/Tarawa', 'UTC+12', '686'],
  '科摩罗': ['KM', 'AF', 'Indian/Comoro', 'UTC+3', '269'],
  '圣基茨和尼维斯': ['KN', 'NA', 'America/St_Kitts', 'UTC-4', '1869'],
  '朝鲜': ['KP', 'AS', 'Asia/Pyongyang', 'UTC+9', '850'],
  '韩国': ['KR', 'AS', 'Asia/Seoul', 'UTC+9', '82'],
  '科威特': ['KW', 'AS', 'Asia/Kuwait', 'UTC+3', '965'],
  '开曼群岛': ['KY', 'NA', 'America/Cayman', 'UTC-5', '1345'],
  '哈萨克斯坦': ['KZ', 'AS', 'Asia/Almaty', 'UTC+6', '327'],
  '老挝': ['LA', 'AS', 'Asia/Vientiane', 'UTC+7', '856'],
  '黎巴嫩': ['LB', 'AS', 'Asia/Beirut', 'UTC+2', '961'],
  '圣卢西亚': ['LC', 'NA', 'America/St_Lucia', 'UTC-4', '1758'],
  '列支敦士登': ['LI', 'EU', 'Europe/Vaduz', 'UTC+1', '423'],
  '斯里兰卡': ['LK', 'AS', 'Asia/Colombo', 'UTC+5:30', '94'],
  ...
  '马绍尔群岛': ['MH', 'AS', 'Pacific/Kwajalein', 'UTC+12', '692'],
  '北马其顿': ['MK', 'EU', 'Europe/Belgrade', 'UTC+1', '389'],
  '马里': ['ML', 'AF', 'Africa/Bamako', 'UTC-0', '223'],
  '缅甸': ['MM', 'AS', 'Asia/Rangoon', 'UTC+6:30', '95'],
  '蒙古': ['MN', 'AS', 'Asia/Ulaanbaatar', 'UTC+8', '976'],
  '中国-澳门': ['MO', 'AS', 'Asia/Macau', 'UTC+8', '853'],
  '北马里亚纳群岛': ['MP', 'AS', 'Pacific/Saipan', 'UTC+10', '1670'],
  ...
  '尼泊尔': ['NP', 'AS', 'Asia/Kathmandu', 'UTC+5:45', '977'],
  '瑙鲁': ['NR', 'AS', 'Pacific/Nauru', 'UTC+12', '674'],
  '纽埃': ['NU', 'AS', 'Pacific/Niue', 'UTC-11', '683'],
  '新西兰': ['NZ', 'AS', 'Pacific/Auckland', 'UTC+13', '64'],
  '阿曼': ['OM', 'AS', 'Asia/Muscat', 'UTC+4', '968'],
  '巴拿马': ['PA', 'NA', 'America/Panama', 'UTC-5', '507'],
  '秘鲁': ['PE', 'LA', 'America/Lima', 'UTC-5', '51'],
  '法属波利尼西亚': ['PF', 'AS', 'Pacific/Tahiti', 'UTC-10', '689'],
  '巴布亚新几内亚': ['PG', 'AS', 'Pacific/Port_Moresby', 'UTC+10', '675'],
  '菲律宾': ['PH', 'AS', 'Asia/Manila', 'UTC+8', '63'],
  '巴基斯坦': ['PK', 'AS', 'Asia/Karachi', 'UTC+5', '92'],
  '波兰': ['PL', 'EU', 'Europe/Warsaw', 'UTC+1', '48'],
  '圣皮埃尔和密克隆群岛': ['PM', 'NA', 'America/Miquelon', 'UTC-3', '508'],
  '波多黎各': ['PR', 'NA', 'America/Puerto_Rico', 'UTC-4', '1787/1939'],
  '巴勒斯坦': ['PS', 'AS', 'Asia/Gaza', 'UTC+2', '970'],
  '葡萄牙': ['PT', 'EU', 'Europe/Lisbon', 'UTC-0', '351'],
  '帕劳': ['PW', 'AS', 'Pacific/Palau', 'UTC+9', '680'],
  '巴拉圭': ['PY', 'LA', 'America/Asuncion', 'UTC-3', '595'],
  '卡塔尔': ['QA', 'AS', 'Asia/Qatar', 'UTC+3', '974'],
  ...
  '沙特阿拉伯': ['SA', 'AS', 'Asia/Riyadh', 'UTC+3', '966'],
  '所罗门群岛': ['SB', 'AS', 'Pacific/Guadalcanal', 'UTC+11', '677'],
  '塞舌尔': ['SC', 'AF', 'Indian/Mahe', 'UTC+4', '248'],
  '苏丹': ['SD', 'AF', 'Africa/Khartoum', 'UTC+2', '249'],
  '瑞典': ['SE', 'EU', 'Europe/Stockholm', 'UTC+1', '46'],
  '新加坡': ['SG', 'AS', 'Asia/Singapore', 'UTC+8', '65'],
  ...
  '叙利亚': ['SY', 'AS', 'Asia/Damascus', 'UTC+2', '963'],
  ...
  '泰国': ['TH', 'AS', 'Asia/Bangkok', 'UTC+7', '66'],
  '塔吉克斯坦': ['TJ', 'AS', 'Asia/Dushanbe', 'UTC+5', '992'],
  '托克劳': ['TK', 'AS', 'Pacific/Fakaofo', 'UTC+13', '690'],
  '东帝汶': ['TL', 'AS', 'Asia/Dili', 'UTC+9', '670'],
  '土库曼斯坦': ['TM', 'AS', 'Asia/Ashgabat', 'UTC+5', '993'],
  '突尼斯': ['TN', 'AF', 'Africa/Tunis', 'UTC+1', '216'],
  '汤加': ['TO', 'AS', 'Pacific/Tongatapu', 'UTC+13', '676'],
  '土耳其': ['TR', 'AS', 'Europe/Istanbul', 'UTC+3', '90'],
  '特立尼达和多巴哥': ['TT', 'NA', 'America/Port_of_Spain', 'UTC-4', '1868'],
  '图瓦卢': ['TV', 'AS', 'Pacific/Funafuti', 'UTC+12', '688'],
  '中国-台湾': ['TW', 'AS', 'Asia/Taipei', 'UTC+8', '886'],
  ...
  '乌兹别克斯坦': ['UZ', 'AS', 'Asia/Samarkand', 'UTC+5', '233'],
  ...
  '越南': ['VN', 'AS', 'Asia/Ho_Chi_Minh', 'UTC+7', '84'],
  '瓦努阿图': ['VU', 'AS', 'Pacific/Efate', 'UTC+11', '678'],
  '瓦利斯和富图纳群岛': ['WF', 'AS', 'Pacific/Wallis', 'UTC+12', '681'],
  '萨摩亚': ['WS', 'AS', 'Pacific/Apia', 'UTC+14', '685'],
  '科索沃': ['XK', 'EU', 'Europe/Belgrade', 'UTC+1', '383'],
  '也门': ['YE', 'AS', 'Asia/Aden', 'UTC+3', '967'],
